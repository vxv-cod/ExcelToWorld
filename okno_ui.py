...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(350, 510)
        Form.setMinimumSize(QtCore.QSize(350, 510))
        ...
        self.gridLayout.addWidget(self.plainTextEdit_10, 6, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.progressBar_1, 8, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "ExcelToWord"))
        ...
        self.comboBox.setItemText(2, _translate("Form", "Формат А3 (альбомный)"))
        self.comboBox.setItemText(3, _translate("Form", "Формат А3 (книжный)"))
        self.comboBox.setItemText(4, _translate("Form", "Спецификация оборудования, изделий и материалов"))
        self.plainTextEdit_10.setPlaceholderText(_translate("Form", "Папка сохранения Word:  адрес открытого файла Excel  или укажите свою папку . . ."))
        ...
        self.plainTextEdit_3.setPlaceholderText(_translate("Form", "Папка с подписями в формате :  *.jpg ,  *.png"))
        ...
        self.pushButton_4.setText(_translate("Form", "Отчёт в MS Word"))
        self.pushButton_4.setShortcut(_translate("Form", "Esc"))
        self.label_2.setText(_translate("Form", "Вставка таблицы из активного листа Excel в шаблон Word"))
